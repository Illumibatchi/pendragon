---
session_number: 21
real_date: 2026-04-15
in_game_year: 487
in_game_season: "Late Spring"
location: "Otherworld (Cardiff) → Pengam Green (Reawakening Fair) → back below (caverns)"
characters:
  - Millicent
  - Drustin
  - Assterius
...
- **Goal:** find a **church with a golden angel** (Guido’s instruction).
- **Directions by gesture:** follow “four blocks + right” style guidance to a fenced Orthodox church.
- **Break-in:** Assterius climbs the fence and lets the armored conroi in.
- **Priest panic:** the priest flees and calls for help; at distance he indicates a larger church—**Llandaff Cathedral**—and provides modern coinage/tokens.
- **Horseless carriage:** a modern driver is summoned; the conroi is brought to Llandaff Cathedral.
- **Golden angel found:** the cathedral’s tower bears the sought golden angel.
- **Merlin lead:** locals point them toward the **Reawakening Fair at Pengam Green**, using the name “Merdwyl.”
- **Prayer clue:** Geraint’s prayer knocks open a psalm/hymn; interpreted as a sign to walk east.
...
- **Time rule:** grievous wounds don’t “finish” you below; once they exit, they have roughly **~6 hours (table shorthand: by midnight after exit)** to get chirurgery or die.

## Characters (appeared / impacted)
- [[Millicent]] — leads the charge in the abomination fight; grievously wounded.
- [[Liam]] — grievously wounded; still manages to strike the monster while down.
- [[Sir Geraint]] — prayer clue; commissions new gear; sneaks a dagger into the museum.
- [[Drustin]] — lands the killing blow on the abomination.
- [[Assterius]] — language/literacy edge; climbs the fence to get the conroi into the first church.
- [[Merlin]] — found preserved in vitriol at a museum; **dead** (empty vessel).
- [[Guido (The Guide)]] — revealed as the slain many-handed abomination.
...
- **Otherworld location confirmed:** the “glass city” is **Cardiff** (the earlier “London?” suspicion was mistaken).
- **Merlin status (future):** body preserved in vitriol; **soul gone / empty vessel**; scholars plan to cut him up soon.
- **Guido’s nature:** the conroi **killed Guido** in the form of a many-handed abomination.
- **Urgent timer:** once the conroi exits the caverns, grievous wounds become fatal on a short clock (~6 hours / “by midnight after exit”).
