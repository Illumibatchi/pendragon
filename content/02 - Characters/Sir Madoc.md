---
type: character
kind: NPC (knight / prince)
first_seen_session: 7
first_seen_year: 481
notes:
  - "Legitimized bastard son of Uther Pendragon"
tags:
  - character
  - npc
relations:
  - type: father
    target: "Uther Pendragon"
    certainty: fact
    note: "Legitimized bastard son"
  - type: uncle
    target: "Aurelius Ambrosius"
    certainty: fact
---
...
- **(488)** — At the [[White Tower]] feast, admits to [[Millicent]] that the prior scandal involved [[Lady Rhianneth]] and says he does not know whether a child exists; later follows a trail to [[St. Mary Bethlehem]], where the company finds him with his head in a nun's lap. *(Source: [[Session 028 - The Easter Feast at the White Tower]])*
